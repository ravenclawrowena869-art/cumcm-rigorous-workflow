...
v2.0 的核心变化不是增加更多“建模技巧”，而是重构团队生产方式：
...
- `04_验收冻结/`：三重验收、Freeze、clean replay、Source of Truth
- `05_论文与图表/`：Paper Pipeline、Figure Registry、图表与页数
...
7. 每个模块按 `IDEA → BASELINE → MAINLINE → VALIDATING → FROZEN → PAPER_LOCKED`
8. 最后 4–6 小时启用 `Model Change Ban`
