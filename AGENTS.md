...
代码实现、实际运行、solver/runner 修改、结果导出或 clean replay 时，至少读取：
- `03_建模与代码/06_代码执行与复现Gate.md`
- `07_AI协作/01_AI_Codex工作协议.md`（使用 Coding Agent 时）
...
并按任务需要继续读取：
- `01_赛前准备/`
- `02_开赛与拆题/03_接口优先原则.md`
- `03_建模与代码/`
- `04_验收冻结/`
- `07_AI协作/`
- `10_容灾与应急/`

长任务、多 Agent、checkpoint/resume 或自动返工再读取：
